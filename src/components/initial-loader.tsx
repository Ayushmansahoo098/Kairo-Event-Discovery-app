...
type LoaderStep = 'loading' | 'ready' | 'transitioning' | 'exiting' | 'done';

const LoaderVisuals = ({ step, progress, setStep }: {
  step: LoaderStep;
  progress: number;
  setStep: (step: LoaderStep) => void
}) => (
...
export function InitialLoader() {
  ...
  return (
    <div className="fixed inset-0 z-[999] pointer-events-none">
      ...
      >
        <LoaderVisuals step={step} progress={progress} setStep={setStep} />
      </motion.div>
