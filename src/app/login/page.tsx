...
export default function LoginPage() {
  ...
  const { login, loginWithGoogle, loginWithGithub, user, isLoading } = useAuthContext();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : "Authentication failed. Please verify your credentials.";
      alert(errorMessage);
    ...
    <div className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 bg-kairo-primary">
      <div className="w-full max-w-md space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="relative flex items-center justify-center my-6">
          ...
          <span className="relative px-4 text-xs text-kairo-light-gray uppercase tracking-widest font-extrabold bg-kairo-primary">
            Or continue with
          </span>
        </div>
        ...
        <p className="text-center text-kairo-gray text-xs">
